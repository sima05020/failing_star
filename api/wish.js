export default async function handler(req, res) {
    ...
    try {
        ...
        // プロンプト定義
        if (mode === 'persona') {
            promptText = `あなたは優秀な現代シナリオライターです。以下の条件でランダムなキャラクターと、その人が今一番叶えたい願いを生成してください。
            ## 生成ルール
            - 属性: 年齢、性別、職業など（例：10歳男子小学生、40歳会社員男性）。
            - 性格: （例：気が弱い、強欲、ロマンチスト）。
            - 願い: 具体的で切実なもの。（例：テストで100点取りたい、フランス製の高級バッグが欲しい、警察から逃げたい）
            ## 出力フォーマット (JSONのみ)
            ...
            50~150文字程度で、その人のキャラなりの結果を生み出してください。
            
            ## 出力フォーマット (JSONのみ)
            { "outcome": "起こった現象（50~150文字程度）" }`;
